...
import { WalasMenu } from '../../components/Links';
import { useState } from 'react';

const Home = () => {
    const [active, setActive] = useState('Home');
    const Menus = WalasMenu;
    return (
        <div>
                    ...
                    {(
                        <div>
                            <div className="mt-5 mb-8 bg-slate-100 rounded-md py-3 px-4">
                                <h1 className='text-xl md:text-2xl font-semibold '>Dashboard Walas</h1>
                                <p>Hi Selamat Datang Wali Kelas!</p>
                            </div>
